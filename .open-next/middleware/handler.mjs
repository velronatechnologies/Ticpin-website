...
var require_y_next_dist_esm_build_templates_edge_wrapper_06sni24 = __commonJS({
  ".next/server/edge/chunks/029y_next_dist_esm_build_templates_edge-wrapper_06sni24.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/029y_next_dist_esm_build_templates_edge-wrapper_06sni24.js", 13824, (e, t, l) => {
      self._ENTRIES ||= {};
      let n = Promise.resolve().then(() => e.i(9203));
      n.catch(() => {
...
var require_root_of_the_server_08tlhhj = __commonJS({
  ".next/server/edge/chunks/[root-of-the-server]__08tlhhj._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__08tlhhj._.js", 98264, (e, t, r) => {
    }, 51945, (e, t, r) => {
      "use strict";
      ...
      let o = e.r(60819), s = { url: (e2) => e2.url, header: (e2, t2) => e2.headers.get(t2) };
  ...
  `);
      ...
      class U {
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[L].basePath, buildId: this[L].buildId, defaultLocale: this[L].options.forceLocale ? void 0 : this[L].defaultLocale, locale: this[L].locale, pathname: this[L].url.pathname, trailingSlash: this[L].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = T(t10)), e10.buildId && (t10 = k(N(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = N(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : k(t10, "/") : T(t10);
        }
        formatSearch() {
      ...
      var $, q, B, H, V, F, G, z, X, W, K, J, Q, Y, Z, ee = e.i(51945);
      ...
      let eB = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: eH, propagation: eV, trace: eF, SpanStatusCode: eG, SpanKind: ez, ROOT_CONTEXT: eX } = t = e.r(35082);
      class eW extends Error {
        constructor(e10, t10) {
      ...
      async function t_(t10) {
        ...
        !function() {
          if (!tb && (tb = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
            let { interceptTestApis: t11, wrapRequestHandler: r3 } = e.r(80506);
            t11(), tm = r3(tm);
          }
        }(), await u();
      ...
      e.s(["config", 0, { matcher: ["/", "/profile/:path*", "/pass/buy/:path*", "/logout/:path*", "/bookings/:path*", "/my-pass/:path*", "/ticlists/:path*", "/myboooking/:path*", "/events/:name/book", "/events/:name/book/:path*", "/dining/venue/:name/book", "/dining/venue/:name/book/:path*", "/play/:name/book", "/play/:name/book/:path*"] }, "middleware", 0, function(e10) {
        ...
        if (t10.startsWith("/dining/") && !a2) return es.redirect(new URL("/dining", e10.url));
        if (i2) {
        ...
        let o2 = re.some((e11) => t10.startsWith(e11)), s2 = /^\/events\/[^\/]+\/book(\/.*)?$/.test(t10) || /^\/dining\/venue\/[^\/]+\/book(\/.*)?$/.test(t10) || /^\/play\/[^\/]+\/book(\/.*)?$/.test(t10), l2 = e10.cookies.get("__Host-ticpin_user_session") ?? e10.cookies.get("ticpin_user_session") ?? e10.cookies.get("ticpin_user_session_info");
        if ((o2 || s2) && !l2) {
          let r3 = e10.nextUrl.search || "";
      ...
      e.s(["default", 0, ri, "handler", 0, ra], 9203);
    }]);
  }
});
...
var require_next_dist_esm_build_templates_edge_wrapper_0wn18qa = __commonJS({
  ".next/server/edge/chunks/0_63_next_dist_esm_build_templates_edge-wrapper_0wn18qa.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/0_63_next_dist_esm_build_templates_edge-wrapper_0wn18qa.js", { otherChunks: ["chunks/029y_next_dist_esm_build_templates_edge-wrapper_06sni24.js", "chunks/[root-of-the-server]__08tlhhj._.js"], runtimeModuleIds: [13824] }]), (() => {
      let e;
...
var init_edgeFunctionHandler = __esm({
  "node_modules/.pnpm/@opennextjs+aws@4.0.2_next@16.2.6_@babel+core@7.29.0_react-dom@18.3.1_react@18.3.1__react@18.3.1_/node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(\\/?index|\\/?index\\.json|\\/?index(?:\\.rsc|\\.segments\\/.+\\.segment\\.rsc)))?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/profile(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/pass\\/buy(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/logout(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/bookings(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/my-pass(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/ticlists(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/myboooking(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/events(?:\\/([^\\/#\\?]+?))\\/book(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/events(?:\\/([^\\/#\\?]+?))\\/book(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dining\\/venue(?:\\/([^\\/#\\?]+?))\\/book(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dining\\/venue(?:\\/([^\\/#\\?]+?))\\/book(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/play(?:\\/([^\\/#\\?]+?))\\/book(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/play(?:\\/([^\\/#\\?]+?))\\/book(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
