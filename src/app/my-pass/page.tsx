...
export default function MyPassComingSoon() {
  return (
    <div className="min-h-screen w-full bg-white text-black flex flex-col justify-between items-center px-6 py-12 relative overflow-hidden font-sans">
      ...
      {/* Main Text Content */}
      <main className="flex-1 flex flex-col items-center justify-center text-center max-w-[650px] w-full relative z-10 py-16">
        ...
        <p className="text-[#555555] text-[15px] sm:text-[16px] max-w-[460px] leading-relaxed mb-8 font-normal">
          We are working on your personalized membership pass to unlock free turf bookings, dining vouchers, and premium event discounts. Stay tuned!
        </p>
