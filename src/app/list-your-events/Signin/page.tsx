            ...
            <main className="flex-1 flex flex-col items-center justify-start pt-20 px-6 overflow-y-auto scrollbar-hide">
                <div className="w-full max-w-[1000px]">
                    ...
                    <p className="text-base font-medium text-black mb-12" style={{ fontSize: '15px', lineHeight: '16px' }}>
                        ...
                        <Link href="/list-your-events/Login" className="text-[#5331EA] border-b border-[#5331EA] hover:opacity-80">Log in</Link>
                    </p>
                    ...
                    {error && (
                        <div className="mb-4">
                            ...
                            {error.includes('already exists') && (
                                <Link href="/list-your-events/Login" className="text-[#5331EA] text-sm border-b border-[#5331EA] hover:opacity-80 mt-1 inline-block">Go to Login →</Link>
                            )}
                        </div>
                    )}
