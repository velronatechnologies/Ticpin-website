...
const NEXT_ROUTE = '/list-your-events/setup/backup';
...
function BankDetailsContent() {
    ...
    const handleContinue = () => {
        ...
        setTimeout(() => router.push(NEXT_ROUTE), 800);
    };
    ...
    return (
        <div className={`overflow-hidden flex flex-col font-[family-name:var(--font-anek-latin)] h-[calc(100vh-80px)] bg-zinc-50`}>
            <main className="flex-1 overflow-y-auto scrollbar-hide px-4 md:px-14 lg:px-32 py-10 md:py-16">
                <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
                    <aside className="w-fit pt-32 hidden lg:block">
                        <SetupSidebar currentStep="03" completedSteps={['01', '02']} category="events" />
                    </aside>
                    <div className="flex-1 flex flex-col pt-4 mt-[-75px]">
                        ...
                        <div className="lg:hidden mb-12"><SetupSidebar currentStep="03" completedSteps={['01', '02']} category="events" /></div>
                        ...
                        <div className="space-y-10 mt-[-15px]">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 max-w-4xl">
                                <div className="space-y-3 mt-[-15px]">
                                    ...
                                    <input type="text" placeholder="eg. Velora Technologies Pvt Ltd." value={accountHolder}
