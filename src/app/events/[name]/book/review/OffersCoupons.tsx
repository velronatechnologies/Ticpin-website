            ...
            <div className="border border-[#AEAEAE] rounded-[15px] overflow-hidden mt-[-10px] bg-[#FDFDFD]">
                ...
                <div>
                    ...
                    >
                        ...
                        {expandedSection === 'coupons' ? <ChevronDown size={26} className="text-black" /> : <ChevronRight size={26} className="text-black" />}
                    </div>
                        ...
                        <div className="p-6 pt-0 space-y-4 animate-in fade-in duration-300">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 h-[45px] border border-[#AEAEAE] rounded-[8px] px-4 focus:outline-none focus:border-black text-[14px] font-medium uppercase placeholder:normal-case placeholder:font-medium text-black bg-white"
                                />
                                <button
                                    onClick={() => validateCoupon()}
                                    disabled={couponLoading || !couponInput.trim()}
                                    className="px-6 h-[45px] bg-black text-white rounded-[8px] uppercase disabled:opacity-40 transition-all active:scale-[0.98]"
                                    style={{
                                        fontFamily: "var(--font-anek-tamil-condensed), 'Anek Tamil Condensed', sans-serif",
                                        fontWeight: 500,
                                        fontSize: '20px'
                                    }}
                                >
                                            ...
                                            <div key={i} className={`flex items-center justify-between p-3 border rounded-[10px] bg-white ${isExpiringSoon ? 'border-orange-300' : 'border-[#F0F0F0]'}`}>
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[11px] text-[#686868]  font-medium">
