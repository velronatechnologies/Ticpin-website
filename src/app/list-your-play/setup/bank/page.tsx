...
function BankDetailsContent() {
    ...
    useEffect(() => {
        ...
        if (!session) { router.replace('/list-your-play/Login'); return; }
        ...
        organizerApi.getExistingSetup('play')
            ...
            .catch((error) => { console.error('Bank setup loading error:', error); })
            ...
            <main className="flex-1 overflow-y-auto scrollbar-hide px-4 md:px-14 lg:px-32 py-10 md:py-16">
                <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 flex flex-col pt-4 mt-[-75px]">
                        ...
                        <div className="lg:hidden mb-12"><SetupSidebar currentStep="03" completedSteps={['01', '02']} category="play" /></div>
