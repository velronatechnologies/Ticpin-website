...
export default function TennisPage() {
    ...
    useEffect(() => {
        fetch('/backend/api/play?category=TENNIS', { credentials: 'include' })
            .then(r => r.json())
            .then((data: RealPlay[]) => {
            ...
            <main className="space-y-12 md:space-y-20">
                ...
                <div className="mx-auto max-w-[1440px] px-4 md:px-10 lg:px-16 space-y-12 md:space-y-16 pb-12 md:pb-20">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20 text-zinc-400 text-lg">No tennis venues found</div>
                    ) : (
