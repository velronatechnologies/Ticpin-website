    ...
    return (
        <div className="space-y-1.5 relative" ref={containerRef}>
            ...
            <div 
                ...
                className={`w-full h-12 border ${error ? 'border-red-500' : 'border-zinc-200'} rounded-lg px-4 flex items-center justify-between bg-white cursor-pointer transition-all ${isOpen ? 'border-black ring-1 ring-black' : ''}`}
            >
                <span className={`text-[15px] ${value ? 'text-black' : 'text-zinc-400'}`}>
                    {value || placeholder}
                </span>
            ...
            {isOpen && (
                <div className="absolute z-[100] top-[calc(100%+4px)] left-0 w-full bg-white border border-zinc-200 rounded-lg shadow-xl max-h-[300px] flex flex-col overflow-hidden animate-in fade-in slide-in-from-top-1 duration-200">
