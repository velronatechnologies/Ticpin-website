...
export default function PlayBookPage() {
    ...
    const handleProfileClick = () => {
        // Booking is user-only — show auth modal if no user session
        if (userSession) {
    ...
    if (mounted && isMobile) {
        return (
            <MobilePlayBooking
                ...
                effectiveDurationLabel={effectiveDurationLabel}
                effectiveDurationSlots={effectiveDurationSlots}
                resolveEffectiveHourlyPrice={resolveEffectiveHourlyPrice}
