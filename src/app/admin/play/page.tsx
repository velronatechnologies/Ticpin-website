...
function DetailViewPanel({ ev, onStatus, updating, onUpdate, onNext, currentIndex, totalCount, onDelete, onClose }: {
  ...
  const detailRows = [
    { label: 'Play Name', field: 'name', value: editedEv.name || '' },
    ...
    { label: 'Per Hour Price', field: 'price_per_slot', value: editedEv.price_per_slot || 0, type: 'number' },
    ...
    { label: 'Field Size', value: 'Standard', readOnly: true },
    ...
    { label: 'Timings (Combined)', field: 'time', value: editedEv.time || '' },
    { label: 'Opening Time', field: 'opening_time', value: editedEv.opening_time || '', placeholder: 'e.g. 06:00 AM' },
    { label: 'Closing Time', field: 'closing_time', value: editedEv.closing_time || '', placeholder: 'e.g. 10:00 PM' },
              ...
              {filtered.map(item => {
                ...
                return (
                  <div key={id} className="relative group">
                    <div
                      onClick={() => router.push(`/admin/play?list=true`)}
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col justify-center">
                        <h3 className="text-[32px] font-bold text-black uppercase leading-tight tracking-tight">{"{"}{item.name || 'PLAY NAME'}{"}"}</h3>
