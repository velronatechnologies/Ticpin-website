            ...
            <main className="flex-1 flex flex-col items-center justify-start pt-20 px-6 overflow-y-auto scrollbar-hide">
                <div className="w-full max-w-[1000px]">
                    ...
                    <p className="text-base font-medium text-black mb-12" style={{ fontSize: '15px', lineHeight: '16px' }}>
                        ...
                        <Link href="/list-your-dining/Login" className="text-[#5331EA] border-b border-[#5331EA] hover:opacity-80">
                            Log in
                        </Link>
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                style={{ height: '65px' }}
                            />
                            <p className="text-sm font-medium text-[#5331EA] mt-4" style={{ fontSize: '15px', lineHeight: '16px' }}>
                    ...
                    {/* Sign up Button */}
                    <Link href="/list-your-dining/setup">
                        <button
