...
export interface AdminListing {
    ...
    guide?: {
        ...
        venue_location_type?: string;
        surface_type?: string;
        cancellations_allowed?: boolean;
        changing_rooms_available?: boolean;
        equipment_rentals_available?: boolean;
        max_duration?: string;
    };
    ...
    weekday_schedules?: Array<{ openTime: string; closeTime: string }>;
    weekend_schedules?: Array<{ openTime: string; closeTime: string }>;
    is_weekend_pricing_different?: boolean;
...
export const adminApi = {
    ...
    /** GET /api/admin/play/:id */
    getPlayById: (id: string) =>
        adminRequest<AdminListing>(`/play/${id}`),
    ...
    /** GET /api/admin/receipt-verification/items */
    getReceiptVerificationItems: (category: string) => 
        adminRequest<Array<{ id: string; name: string }>>(`/receipt-verification/items?category=${category}`),

    /** GET /api/admin/receipt-verification/bookings */
    getReceiptVerificationBookings: (category: string, itemId: string) => 
        adminRequest<Array<any>>(`/receipt-verification/bookings?category=${category}&itemId=${itemId}`),

    /** POST /api/admin/receipt-verification/approve */
    approveReceiptVerification: (category: string, bookingId: string) => 
        adminRequest<{ message: string }>('/receipt-verification/approve', {
            method: 'POST',
            body: JSON.stringify({ category, bookingId }),
        }),
};
