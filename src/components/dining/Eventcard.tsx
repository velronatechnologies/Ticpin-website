            ...
            <div className="relative h-[32px] bg-gradient-to-r from-[#866BFF] to-[#BDB1F3] flex items-center px-4">
                {tag && (
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-white text-[12px] font-medium tracking-tight whitespace-nowrap">{tag}</span>
                    </div>
                )}
            </div>
            ...
            <div className="relative h-[124px] bg-white p-5 flex flex-col justify-between">
                <div>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        <div className="flex items-center gap-1 px-2.5 py-1 rounded-[5px] text-white shadow-sm" style={{ background: 'rgba(41, 129, 3, 1)' }}>
                            <Star size={10} fill="white" className="text-white" />
                            <span className="text-[10px] font-black">{rating || '4.0'}</span>
                        </div>
