    ...
    return (
        <div className="md:hidden min-h-screen w-full bg-[#F5F5F5] font-sans px-5 pt-6 pb-20 overflow-x-hidden overflow-y-auto" style={{ fontFamily: 'var(--font-anek-latin), sans-serif' }}>
            ...
            <div className="bg-white rounded-[20px] border border-[#E5E5E5] overflow-hidden mb-4">
                {[
                    { icon: <Heart size={20} className="text-zinc-600" />, label: 'Ticlists', onClick: () => router.push('/my-pass') },
            ...
            <div className="bg-white rounded-[20px] border border-[#E5E5E5] overflow-hidden mb-4">
                {[
                    { icon: <HelpCircle size={20} className="text-zinc-600" />, label: 'Frequently asked questions', onClick: () => router.push('/terms') },
