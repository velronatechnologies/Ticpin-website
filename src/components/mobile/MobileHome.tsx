...
import { Search, MapPin, ChevronRight, Star, Bell, Calendar, Utensils, PlayCircle } from 'lucide-react';
...
export default function MobileHome({ events, dinings, plays }: MobileHomeProps) {
    ...
    const handleResultClick = (result: { type: string; name: string; id: string }) => {
    ...
    return (
        ...
        >
            ...
            <header className="px-6 pt-7 pb-4">
                <div className="flex justify-between items-center mb-10">
                    ...
                    >
                        ...
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-0.5 mt-0.5">
                ...
                <div className="grid grid-cols-3 gap-4 px-1 text-center">
                    ...
                    <div className="flex flex-col items-center" onClick={() => router.push('/dining')}>
                        <div
                            className="w-full aspect-[106/125] rounded-[25px] flex flex-col items-center justify-center gap-2 cursor-pointer border border-[#D9D9D9] active:scale-95 transition-all duration-300"
            ...
            <main className="mt-12 space-y-16 pb-12">
                ...
                {(localDinings.length > 0 || localPlays.length > 0) && (
                    /* Offers Section */
                ...
                <div className="px-6">
                    <button
                        ...
                        className="w-full rounded-[15px] overflow-hidden relative h-[120px] mt-[-25px] block active:scale-[0.98] transition-transform"
                    >
