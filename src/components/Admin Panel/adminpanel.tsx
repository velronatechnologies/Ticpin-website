...
import { User, ArrowLeft, FileCheck } from 'lucide-react';
        ...
        >
            <div className="flex-1 mx-auto w-full max-w-[1440px] px-6 md:px-[68px] py-12 md:py-20 space-y-12 md:space-y-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 md:gap-x-12 md:gap-y-16">
                    ...
                    <Card title="Payouts" iconSrc="/admin panel/payout-icon.svg" href="/admin/payouts" />
                    <Card title="Receipt Verification" iconComponent={<FileCheck />} href="/admin/receipt-verification" />
                </div>
            </div>
