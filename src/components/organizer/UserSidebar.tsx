...
export default function UserSidebar({ isOpen, onClose }: UserSidebarProps) {
    ...
    return (
        <>
            ...
            {isOpen && (
                <div 
                    className="fixed inset-0 bg-black/20 backdrop-blur-sm z-[111]"
                    onClick={onClose}
                />
            )}
            ...
            {/* Sidebar */}
            <div 
                className={`fixed top-[114px] right-0 w-[280px] h-[calc(100vh-114px)] bg-white shadow-[-4px_0_15px_rgba(0,0,0,0.1)] z-[112] transition-transform duration-300 transform ${
